...
import ru.rozum.weatherapp.R
import ru.rozum.weatherapp.domain.entity.Forecast
import ru.rozum.weatherapp.domain.entity.Weather
import ru.rozum.weatherapp.presentation.extesions.formattedFullDate
import ru.rozum.weatherapp.presentation.extesions.formattedShortDayOfWeek
import ru.rozum.weatherapp.presentation.extesions.tempToFormattedString
    ...
    CenterAlignedTopAppBar(
        ...
        actions = {
            IconButton(onClick = { onClickChangeFavouriteStatus() }) {
                val star = if (isCityFavourite) Icons.Default.Star else Icons.Default.StarBorder
                Icon(
                    imageVector = star,
                    contentDescription = null,
                    tint = MaterialTheme.colorScheme.background
...
@Composable
private fun UpcomingWeather(modifier: Modifier = Modifier, upcoming: List<Weather>) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(24.dp),
...
@OptIn(ExperimentalGlideComposeApi::class)
@Composable
private fun RowScope.SmallWeatherCard(modifier: Modifier = Modifier, weather: Weather) {
    Card(
        colors = CardDefaults.cardColors(
